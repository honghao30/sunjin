	...
	<div :style="'width:' + data.tableWidth">
		<div :class="data.classContent">
			...
			<el-table
				...
				align="center">
				<el-table-column type="selection" :min-width="data.firstColumnWidth"></el-table-column>
				<el-table-column label="No." :min-width="data.firtstColumnWidth">
